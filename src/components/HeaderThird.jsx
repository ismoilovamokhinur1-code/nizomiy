            ...
            <div className="container headersecond-wrap">
                ...
                <div className="flex header-side-3">
                    <div className="header-third">
                        <h1 className="text-white text-[55px] font-medium">News</h1>
                        <p className="text-white">
                           Follow the latest news, important events, and announcements of our institute in this section. Up-to-date information for students and teachers is regularly updated.
                        </p>
